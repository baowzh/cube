...
if (!class_exists('\Eccube\Entity\Layout')) {
    ...
    class Layout extends AbstractEntity
    {
        ...
        {
            return in_array($this->id, [self::DEFAULT_LAYOUT_PREVIEW_PAGE, self::DEFAULT_LAYOUT_TOP_PAGE, self::DEFAULT_LAYOUT_UNDERLAYER_PAGE, self::DEFAULT_TEST_LAYOUT]);
        }
        ...
        public function getHeaderDlh()      // header dlh
        {
            return $this->getBlocks(self::TARGET_ID_HEADER_DLH);
        }
